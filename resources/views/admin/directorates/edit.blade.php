                    ...
                    <div class="mb-6 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="Name" name="title" type="text" :value="old('title', $directorate->title)"
                                    placeholder="Enter directorate name" :error="$errors->first('title')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.text-area label="Description" name="description" :value="old('description', $directorate->description)"
                            ...
                            <div class="col-span-full">
                                <x-forms.multi-select label="Departments" name="departments[]" :options="collect($departments)
                                    ...
                                    )" multiple placeholder="Select departments" :error="$errors->first('departments')" />
                            </div>
                        </div>
                    </div>
