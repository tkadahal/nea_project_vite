<x-layouts.app>
    ...
    <div class="alert alert-info">
        <p><strong>Instructions for Uploading Project Activities:</strong></p>
        <ul>
            <li>Fill data in the Capital Expenditure and Recurrent Expenditure sheets.</li>
            <li>Use the # column for hierarchy (e.g., 1, 1.1, 1.1.1).</li>
            <li><strong>Validation Rules:</strong></li>
            <li>Planned Budget must equal Q1 + Q2 + Q3 + Q4 per row.</li>
            <li>Parent rows must equal sum of direct children.</li>
    ...
    <div
        ...
        <!-- Upload Form -->
        <form action="{{ route('admin.projectActivity.upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-6">
