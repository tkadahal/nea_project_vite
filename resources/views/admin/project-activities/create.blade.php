                        ...
                        <table id="capital-activities"
                            ...
                            <thead>
                                ...
                                <tr class="bg-gray-200 dark:bg-gray-600 header-row-1">
                                    ...
                                    <th class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-sm font-semibold text-gray-700 dark:text-gray-200 text-center"
                                        colspan="2">{{ trans('global.projectActivity.fields.planned_budget') }}</th>
                                    <th class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-sm font-semibold text-gray-700 dark:text-gray-200 text-center"
                ...
                $(document).on('input',
                    ...
                    function() {
                        ...
                        if (depth > 0 && field && ['total_budget_quantity', 'total_budget',
                                ...
                                'planned_budget', 'q1_quantity', 'q1', 'q2_quantity', 'q2', 'q3_quantity', 'q3',
                                'q4_quantity', 'q4'
                            ].includes(field)) {
                            const parentIndex = $row.data('parent');
                            const $parentRow = $(`#${section}-activities tr[data-index="${parentIndex}"]`);
                            const $siblingRows = $(`#${section}-activities tr[data-parent="${parentIndex}"]`).not(
                                $row);
                            let selector;
                            if (field === 'total_budget_quantity') selector = '.total-budget-quantity-input';
                            else if (field === 'total_budget') selector = '.total-budget-input';
                            else if (field === 'total_expense_quantity') selector = '.total-expense-quantity-input';
