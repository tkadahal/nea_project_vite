<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Create new role') }}</p>
    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-full">
                                <x-forms.multi-select label="Permissions" name="permissions[]" :options="collect($permissions)
                                    ...
                                    ->values()
                                    ->all()"
                                    :selected="old('permissions', [])" multiple placeholder="Select permissions" :error="$errors->first('permissions')" />
                            </div>
                        </div>
                    </div>
