<x-layouts.app>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Status') }}</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Update Status') }}</p>
        </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-1">
            <div
                ...
                <div class="p-6">
                    <form class="max-w-md mb-10" action="{{ route('admin.status.update', $status->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
