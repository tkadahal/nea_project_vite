    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.permission.store') }}" method="POST">
                    @csrf
                    ...
                    <div
                        ...
                        <h3
                            ...
                            {{ trans('global.permission.title_singular') }} {{ trans('global.information') }}
                        </h3>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="{{ trans('global.permission.fields.title') }}" name="title"
