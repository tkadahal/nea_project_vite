    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.priority.update', $priority->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div
                        ...
                        <h3
                            ...
                            {{ trans('global.priority.title_singular') }} {{ trans('global.information') }}
                        </h3>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

                            <div class="col-span-full">
                                <x-forms.input label="{{ trans('global.priority.fields.title') }}" name="title"
                                    type="text" value="{{ old('title', $priority->title) }}" />
                            </div>
                        </div>
                    </div>
