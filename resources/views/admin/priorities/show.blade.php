    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">
                {{ trans('global.priority.title') }} {{ trans('global.details') }}
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ trans('global.priority.fields.title') }}
                </p>
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ trans('global.priority.fields.created_at') }}
                </p>
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ trans('global.priority.fields.updated_at') }}
                </p>
                <p class="mt-1 text-lg text-gray-900 dark:text-gray-100">
        ...
        <div class="mt-6 flex space-x-3">
            @can('priority_edit')
                <a href="{{ route('admin.priority.edit', $priority) }}"
                    ...
                    {{ trans('global.edit') }} {{ trans('global.priority.title_singular') }}
                </a>
            @endcan
            ...
            @can('priority_delete')
                <form action="{{ route('admin.priority.destroy', $priority) }}" method="POST"
                    ...
                    <button type="submit"
                        ...
                        {{ trans('global.delete') }} {{ trans('global.priority.title_singular') }}
                    </button>
                </form>
            @endcan
        </div>
